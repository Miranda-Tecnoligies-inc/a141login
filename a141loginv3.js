class Login{
    ...
    static config={
         cor:null,//"048",//hastag está embaixo 
         img:null//"./miranda tecnologies.png"
     };
    static endpoint=null//"http://localhost:8080";

    static login=(callback_ok,callback_nook,config)=>{//pas,mat,foram retirados, mas precisei retirar a linha this.endpoint+=...linha 22
